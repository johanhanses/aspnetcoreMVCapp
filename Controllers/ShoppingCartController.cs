...
namespace Shoppen.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        public ShoppingCartController(IAlbumRepository albumRepository,
        ...
        public RedirectToActionResult AddToShoppingCart(int albumId)
        {
            var selectedAlbum = _albumRepository.AllAlbums.FirstOrDefault(a => a.AlbumId == albumId);
